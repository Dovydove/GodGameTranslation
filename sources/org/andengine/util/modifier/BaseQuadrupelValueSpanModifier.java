...
public abstract class BaseQuadrupelValueSpanModifier<T> extends BaseTripleValueSpanModifier<T> {
    ...
    public abstract void onSetInitialValues(T t, float f, float f2, float f3, float f4);

    /* access modifiers changed from: protected */
    public abstract void onSetValues(T t, float f, float f2, float f3, float f4, float f5);
    ...
    /* access modifiers changed from: protected */
    public void onSetInitialValues(T pItem, float pValueA, float pValueB, float pValueC) {
        onSetInitialValues(pItem, pValueA, pValueB, pValueC, this.mFromValueD);
    }

    /* access modifiers changed from: protected */
    public void onSetValues(T pItem, float pPercentageDone, float pValueA, float pValueB, float pValueC) {
