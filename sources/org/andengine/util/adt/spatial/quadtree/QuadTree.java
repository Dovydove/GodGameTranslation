...
public abstract class QuadTree<B extends IBounds, T extends ISpatialItem<B>> implements IBounds {
    ...
    public abstract class QuadTreeNode implements IBounds {
        ...
        public abstract void appendBoundsToString(StringBuilder sb);

        /* access modifiers changed from: protected */
        public abstract boolean containedBy(B b);

        /* access modifiers changed from: protected */
        public abstract boolean contains(BoundsSplit boundsSplit, B b);
        ...
        /* access modifiers changed from: protected */
        public abstract boolean intersects(B b, B b2);

        /* access modifiers changed from: protected */
        public abstract QuadTreeNode split(BoundsSplit boundsSplit);
        ...
        public String toString(int pIndent) {
            ...
            Arrays.fill(indents, 9);
            StringBuilder sb = new StringBuilder().append(indents).append('[').append(" Class: ").append(getClass().getSimpleName()).append(10).append(indents).append(9).append("Level: ").append(this.mLevel).append(',').append(10).append(indents).append(9).append("Bounds: ");
            appendBoundsToString(sb);
            sb.append(',').append(10).append(indents).append("\tItems: ");
            if (this.mItems != null) {
                sb.append(this.mItems.toString());
            } else {
                sb.append("[]");
            }
            sb.append(10).append(indents).append(9).append("Children: [");
            if (this.mTopLeftChild == null && this.mTopRightChild == null && this.mBottomLeftChild == null && this.mBottomRightChild == null) {
                ...
                sb.append(10).append(indents).append(9).append(']');
            }
            sb.append(10).append(indents).append(']');
            return sb.toString();
        }
        ...
        public ArrayList<T> getItemsAndItemsBelow() {
            return (ArrayList) getItemsAndItemsBelow((L) new ArrayList());
        }
        ...
        public <L extends List<S>, S extends T> L getItemsAndItemsBelowForSubclass(IMatcher<T> pMatcher, L pResult) throws ClassCastException {
            if (this.mItems != null) {
                int itemCount = this.mItems.size();
                for (int i = 0; i < itemCount; i++) {
                    T item = (ISpatialItem) this.mItems.get(i);
                    if (pMatcher.matches(item)) {
                        pResult.add(item);
                    }
                }
        ...
        public void addItemSafe(T pItem) {
            if (this.mItems == null) {
    ...
    /* access modifiers changed from: protected */
    public abstract QuadTreeNode getRoot();

    /* access modifiers changed from: protected */
    public abstract QuadTreeNode initRoot(B b);
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder().append('[').append(" Class: ").append(getClass().getSimpleName()).append(10).append(9).append("MaxLevel: ").append(this.mMaxLevel).append(',').append(10).append(9).append("Bounds: ");
        this.mRoot.appendBoundsToString(sb);
        sb.append(',').append(10).append(9).append("Root:").append(10).append(this.mRoot.toString(2)).append(10).append(']');
        return sb.toString();
    }
    ...
    public synchronized void add(T pItem, B pBounds) {
        if (!this.mRoot.contains(pBounds)) {
            Debug.m1284w("pBounds are out of the bounds of this " + getClass().getSimpleName() + ".");
    ...
    public synchronized ArrayList<T> query(B pBounds) {
        return (ArrayList) query(pBounds, (L) new ArrayList());
    }
