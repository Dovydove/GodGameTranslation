...
public class FloatQuadTree<T extends ISpatialItem<IFloatBounds>> extends QuadTree<IFloatBounds, T> implements IFloatBounds {
    ...
    public class FloatQuadTreeNode extends QuadTreeNode implements IFloatBounds {
        ...
        public FloatQuadTreeNode(FloatQuadTree this$02, int pLevel, IFloatBounds pFloatBounds) {
        ...
        public FloatQuadTreeNode split(BoundsSplit pBoundsSplit) {
        ...
        /* access modifiers changed from: protected */
        public boolean contains(IFloatBounds pFloatBounds) {
            return contains(pFloatBounds.getXMin(), pFloatBounds.getYMin(), pFloatBounds.getXMax(), pFloatBounds.getYMax());
        }

        /* access modifiers changed from: protected */
        public boolean contains(BoundsSplit pBoundsSplit, IFloatBounds pFloatBounds) {
        ...
        /* access modifiers changed from: protected */
        public boolean intersects(IFloatBounds pFloatBounds) {
        ...
        /* access modifiers changed from: protected */
        public boolean intersects(IFloatBounds pFloatBoundsA, IFloatBounds pFloatBoundsB) {
            return FloatBoundsUtils.intersects(pFloatBoundsA, pFloatBoundsB);
        }

        /* access modifiers changed from: protected */
        public boolean containedBy(IFloatBounds pFloatBounds) {
        ...
        /* access modifiers changed from: protected */
        public void appendBoundsToString(StringBuilder pStringBuilder) {
    ...
    /* access modifiers changed from: protected */
    public FloatQuadTreeNode initRoot(IFloatBounds pFloatBounds) {
    ...
    /* access modifiers changed from: protected */
    public FloatQuadTreeNode getRoot() {
    ...
    public synchronized <L extends List<T>> L query(float pX, float pY, L pResult) {
        this.mQueryFloatBounds.set(pX, pY);
        return query(this.mQueryFloatBounds, pResult);
    }

    public synchronized ArrayList<T> query(float pX, float pY, IMatcher<T> pMatcher) {
        this.mQueryFloatBounds.set(pX, pY);
        return query(this.mQueryFloatBounds, pMatcher);
    }
