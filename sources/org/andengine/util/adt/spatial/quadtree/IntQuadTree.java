...
public class IntQuadTree<T extends ISpatialItem<IIntBounds>> extends QuadTree<IIntBounds, T> implements IIntBounds {
    ...
    public class IntQuadTreeNode extends QuadTreeNode implements IIntBounds {
        ...
        public IntQuadTreeNode(IntQuadTree this$02, int pLevel, IIntBounds pIntBounds) {
        ...
        public IntQuadTreeNode split(BoundsSplit pBoundsSplit) {
            int width = getWidth();
        ...
        /* access modifiers changed from: protected */
        public boolean contains(IIntBounds pIntBounds) {
            return contains(pIntBounds.getXMin(), pIntBounds.getYMin(), pIntBounds.getXMax(), pIntBounds.getYMax());
        }

        /* access modifiers changed from: protected */
        public boolean contains(BoundsSplit pBoundsSplit, IIntBounds pIntBounds) {
        ...
        /* access modifiers changed from: protected */
        public boolean intersects(IIntBounds pIntBounds) {
        ...
        /* access modifiers changed from: protected */
        public boolean intersects(IIntBounds pIntBoundsA, IIntBounds pIntBoundsB) {
            return IntBoundsUtils.intersects(pIntBoundsA, pIntBoundsB);
        }

        /* access modifiers changed from: protected */
        public boolean containedBy(IIntBounds pBounds) {
    ...
    /* access modifiers changed from: protected */
    public IntQuadTreeNode initRoot(IIntBounds pIntBounds) {
    ...
    /* access modifiers changed from: protected */
    public IntQuadTreeNode getRoot() {
    ...
    public synchronized <L extends List<T>> L query(int pX, int pY, L pResult) {
        this.mQueryIntBounds.set(pX, pY);
        return query(this.mQueryIntBounds, pResult);
    }

    public synchronized ArrayList<T> query(int pX, int pY, IMatcher<T> pMatcher) {
        this.mQueryIntBounds.set(pX, pY);
        return query(this.mQueryIntBounds, pMatcher);
    }
