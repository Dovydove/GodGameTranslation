...
public class Color {
    ...
    private final void packABGRRed() {
        this.mABGRPackedInt = (this.mABGRPackedInt & -256) | (((int) (255.0f * this.mRed)) << -256);
        this.mABGRPackedFloat = ColorUtils.convertPackedIntToPackedFloat(this.mABGRPackedInt);
    }

    private final void packABGRGreen() {
        this.mABGRPackedInt = (this.mABGRPackedInt & -65281) | (((int) (255.0f * this.mGreen)) << -65281);
        this.mABGRPackedFloat = ColorUtils.convertPackedIntToPackedFloat(this.mABGRPackedInt);
    }

    private final void packABGRBlue() {
        this.mABGRPackedInt = (this.mABGRPackedInt & -16711681) | (((int) (255.0f * this.mBlue)) << -16711681);
        this.mABGRPackedFloat = ColorUtils.convertPackedIntToPackedFloat(this.mABGRPackedInt);
    }

    private final void packABGRAlpha() {
        this.mABGRPackedInt = (this.mABGRPackedInt & 16777215) | (((int) (255.0f * this.mAlpha)) << 24);
        this.mABGRPackedFloat = ColorUtils.convertPackedIntToPackedFloat(this.mABGRPackedInt);
    }
