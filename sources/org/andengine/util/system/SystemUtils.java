...
public class SystemUtils {
    ...
    static {
        ...
        SDK_VERSION_FROYO_OR_LATER = z2;
        if (VERSION.SDK_INT >= 9) {
            z3 = true;
        } else {
            z3 = false;
        }
        SDK_VERSION_GINGERBREAD_OR_LATER = z3;
        if (VERSION.SDK_INT >= 11) {
            z4 = true;
        } else {
            z4 = false;
        }
        SDK_VERSION_HONEYCOMB_OR_LATER = z4;
        if (VERSION.SDK_INT < 14) {
            z5 = false;
        }
        SDK_VERSION_ICE_CREAM_SANDWICH_OR_LATER = z5;
    }

    public static boolean isGoogleTV(Context pContext) {
        return hasSystemFeature(pContext, DeviceProperties.FEATURE_TV_1);
    }
