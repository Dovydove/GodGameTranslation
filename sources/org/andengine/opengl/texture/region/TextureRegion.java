...
public class TextureRegion extends BaseTextureRegion {
    ...
    /* renamed from: mU */
    protected float f1213mU;
    protected float mU2;

    /* renamed from: mV */
    protected float f1214mV;
    protected float mV2;
    ...
    public void updateUV() {
        ...
        float x = getTextureX();
        float y = getTextureY();
        this.f1213mU = (x + 0.5f) / textureWidth;
        this.mU2 = ((this.mTextureWidth + x) - 0.5f) / textureWidth;
        this.f1214mV = (y + 0.5f) / textureHeight;
        this.mV2 = ((this.mTextureHeight + y) - 0.5f) / textureHeight;
    }
}
