...
public class RenderTexture extends Texture {
    ...
    public void writeTextureToHardware(GLState pGLState) {
    ...
    public void init(GLState pGLState) throws GLFrameBufferException, GLException {
        ...
        try {
            ...
            destroy(pGLState);
            throw new RenderTextureInitializationException((Throwable) e2);
        } catch (Throwable th) {
            restorePreviousFramebufferObjectID(pGLState);
            throw th;
        }
    ...
    /* access modifiers changed from: protected */
    public void savePreviousFramebufferObjectID(GLState pGLState) {
        this.mPreviousFramebufferObjectID = pGLState.getActiveFramebuffer();
    }

    /* access modifiers changed from: protected */
    public void restorePreviousFramebufferObjectID(GLState pGLState) {
        pGLState.bindFramebuffer(this.mPreviousFramebufferObjectID);
    }

    /* access modifiers changed from: protected */
    public void savePreviousViewport() {
    ...
    /* access modifiers changed from: protected */
    public void resotorePreviousViewport() {
