    ...
    public static FileBitmapTextureAtlasSource create(File pFile, int pTextureX, int pTextureY) {
        ...
        try {
            ...
            try {
                ...
                in = in2;
                try {
                    Debug.m1274e("Failed loading Bitmap in " + FileBitmapTextureAtlasSource.class.getSimpleName() + ". File: " + pFile, (Throwable) e);
    ...
    public Bitmap onLoadBitmap(Config pBitmapConfig) {
        ...
        try {
            ...
            try {
                ...
                in = in2;
                try {
                    Debug.m1274e("Failed loading Bitmap in " + getClass().getSimpleName() + ". File: " + this.mFile, (Throwable) e);
                    StreamUtils.close(in);
                    return bitmap;
                } catch (Throwable th) {
                    th = th;
