...
public class RenderSurfaceView extends GLSurfaceView {
    ...
    public void onMeasure(int pWidthMeasureSpec, int pHeightMeasureSpec) {
        if (isInEditMode()) {
            super.onMeasure(pWidthMeasureSpec, pHeightMeasureSpec);
        } else {
            this.mEngineRenderer.mEngine.getEngineOptions().getResolutionPolicy().myMeasure(this, pWidthMeasureSpec, pHeightMeasureSpec);
        }
    }
