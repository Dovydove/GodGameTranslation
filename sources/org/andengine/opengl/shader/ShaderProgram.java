...
public class ShaderProgram {
    ...
    public ShaderProgram(String pVertexShaderSource, String pFragmentShaderSource) {
        this((IShaderSource) new StringShaderSource(pVertexShaderSource), (IShaderSource) new StringShaderSource(pFragmentShaderSource));
    }
    ...
    public void compile(GLState pGLState) throws ShaderProgramException {
    ...
    /* access modifiers changed from: protected */
    public void link(GLState pGLState) throws ShaderProgramLinkException {
    ...
    private void initUniformLocations() throws ShaderProgramLinkException {
        ...
        for (int i = 0; i < numUniforms; i++) {
            ...
            if (length == 0) {
                while (length < 64 && NAME_CONTAINER[length] != 0) {
                    length++;
                }
            }
            ...
            if (location == -1) {
                int length2 = 0;
                while (length2 < 64 && NAME_CONTAINER[length2] != 0) {
                    length2++;
                }
                name = new String(NAME_CONTAINER, 0, length2);
