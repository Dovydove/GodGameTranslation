...
public class ShaderProgramManager {
    ...
    public synchronized void onCreate() {
        ...
        loadShaderProgram(C0798xbf9afb3a.getInstance());
    }
    ...
    public synchronized void loadShaderProgram(ShaderProgram pShaderProgram) {
        ...
        if (pShaderProgram.isCompiled()) {
            Debug.m1284w("Loading an already compiled " + ShaderProgram.class.getSimpleName() + ": '" + pShaderProgram.getClass().getSimpleName() + "'. '" + pShaderProgram.getClass().getSimpleName() + "' will be recompiled.");
            pShaderProgram.setCompiled(false);
        }
        if (this.mShaderProgramsManaged.contains(pShaderProgram)) {
            Debug.m1284w("Loading an already loaded " + ShaderProgram.class.getSimpleName() + ": '" + pShaderProgram.getClass().getSimpleName() + "'.");
        } else {
