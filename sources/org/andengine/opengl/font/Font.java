...
public class Font implements IFont {
    ...
    public Bitmap getLetterBitmap(Letter pLetter) throws FontException {
    ...
    /* access modifiers changed from: protected */
    public void drawLetter(String pCharacterAsString, float pLeft, float pTop) {
    ...
    private Letter createLetter(char pCharacter) throws FontException {
        ...
        if (Character.isWhitespace(pCharacter) || letterWidth == 0 || letterHeight == 0) {
    ...
    /* access modifiers changed from: protected */
    public void updateTextBounds(String pCharacterAsString) {
