...
public class FontUtils {
    ...
    public static <L extends List<CharSequence>> L splitLines(CharSequence pText, L pResult) {
        return TextUtils.split(pText, 10, pResult);
    }
        ...
        while (i < textLength) {
            ...
            while (true) {
                ...
                if (j == textLength) {
                    ...
                    lineEnd++;
                    if (measureText(pFont, pText, lineStart2, lineEnd) > pAutoWrapWidth) {
                        if (lineStart2 < lineEnd - 1) {
                            lineEnd--;
                        }
                        pResult.add(pText.subSequence(lineStart2, lineEnd));
                        charsAvailable = false;
                        i = lineEnd;
                    } else {
                        i = lineEnd;
