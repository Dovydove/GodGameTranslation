...
import org.andengine.util.adt.p029io.p030in.AssetInputStreamOpener;
...
public class BitmapFont implements IFont {
    ...
    public final BitmapTextureFormat mBitmapTextureFormat;
    ...
    public static class BitmapFontOptions {
        ...
        /* access modifiers changed from: private */
        public final int mTextureOffsetX;
        /* access modifiers changed from: private */
        public final int mTextureOffsetY;
    ...
    public class BitmapFontPage {
        ...
        public BitmapFontPage(AssetManager pAssetManager, String pAssetBasePath, String pData) throws IOException {
            ...
            } else if (!pageAttributes[0].equals("page")) {
                throw new FontException("Expected: 'page' attributes.");
            } else {
                this.mID = BitmapFont.getIntAttribute(pageAttributes, 1, "id");
        ...
        try {
            ...
            if (commonAttributes.length - 1 != 6) {
                ...
                for (int i = 0; i < this.mBitmapFontPageCount; i++) {
                    BitmapFontPage[] bitmapFontPageArr = this.mBitmapFontPages;
                    BitmapFontPage bitmapFontPage = new BitmapFontPage(pAssetManager, assetBasePath, bufferedReader.readLine());
                    bitmapFontPageArr[i] = bitmapFontPage;
                }
                ...
                if (charsAttributes.length - 1 != 1) {
                    ...
                    parseCharacters(getIntAttribute(charsAttributes, 1, "count"), bufferedReader);
                    ...
                    if (kernings != null && kernings.startsWith(TAG_KERNINGS)) {
                        ...
                        if (kerningsAttributes.length - 1 != 1) {
                            ...
                            parseKernings(getIntAttribute(kerningsAttributes, 1, "count"), bufferedReader);
                        }
                    }
            ...
            FontException fontException = new FontException("Failed loading BitmapFont. AssetPath: " + pAssetPath, e);
            throw fontException;
        } catch (Throwable th) {
            StreamUtils.close(in);
            throw th;
    ...
    private void parseCharacters(int pCharacterCount, BufferedReader pBufferedReader) throws IOException {
        ...
        while (i >= 0) {
            ...
            if (charAttributes.length - 1 != 10) {
                ...
                char id = getCharAttribute(charAttributes, 1, "id");
                ...
                ITexture bitmapFontPageTexture = this.mBitmapFontPages[getIntAttribute(charAttributes, 9, "page")].getTexture();
    ...
    /* access modifiers changed from: private */
    public static boolean getBooleanAttribute(String[] pData, int pPosition, String pAttribute) {
    ...
    /* access modifiers changed from: private */
    public static int getIntAttribute(String[] pData, int pPosition, String pAttribute) {
        String data = pData[pPosition];
        int attributeLength = pAttribute.length();
        if (data.startsWith(pAttribute) && data.charAt(attributeLength) == '=') {
    ...
    /* access modifiers changed from: private */
    public static String getStringAttribute(String[] pData, int pPosition, String pAttribute) {
        String data = pData[pPosition];
        int attributeLength = pAttribute.length();
        if (data.startsWith(pAttribute) && data.charAt(attributeLength) == '=') {
    ...
    /* access modifiers changed from: private */
    public static String getAttribute(String[] pData, int pPosition, String pAttribute) {
        String data = pData[pPosition];
        int attributeLength = pAttribute.length();
