...
public class SkewModifier extends DoubleValueSpanEntityModifier {
    ...
    public void onSetInitialValues(IEntity pEntity, float pSkewX, float pSkewY) {
        pEntity.setSkew(pSkewX, pSkewY);
    }

    /* access modifiers changed from: protected */
    public void onSetValues(IEntity pEntity, float pPercentageDone, float pSkewX, float pSkewY) {
        pEntity.setSkew(pSkewX, pSkewY);
    }
}
