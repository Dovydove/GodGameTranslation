...
public abstract class Shape extends Entity implements IShape {
    ...
    /* access modifiers changed from: protected */
    public void initBlendFunction(ITextureRegion pTextureRegion) {
        initBlendFunction(pTextureRegion.getTexture());
    }

    /* access modifiers changed from: protected */
    public void initBlendFunction(ITexture pTexture) {
        initBlendFunction(pTexture.getTextureOptions());
    }

    /* access modifiers changed from: protected */
    public void initBlendFunction(TextureOptions pTextureOptions) {
