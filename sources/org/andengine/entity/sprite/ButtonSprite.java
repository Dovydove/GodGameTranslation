...
public class ButtonSprite extends TiledSprite {
    ...
    public ButtonSprite(float pX, float pY, ITextureRegion pNormalTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, OnClickListener pOnClickListener) {
        TiledTextureRegion tiledTextureRegion = new TiledTextureRegion(pNormalTextureRegion.getTexture(), pNormalTextureRegion);
        this(pX, pY, (ITiledTextureRegion) tiledTextureRegion, pVertexBufferObjectManager, pOnClickListener);
    }
    ...
    public ButtonSprite(float pX, float pY, ITextureRegion pNormalTextureRegion, ITextureRegion pPressedTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, OnClickListener pOnClickListener) {
        TiledTextureRegion tiledTextureRegion = new TiledTextureRegion(pNormalTextureRegion.getTexture(), pNormalTextureRegion, pPressedTextureRegion);
        this(pX, pY, (ITiledTextureRegion) tiledTextureRegion, pVertexBufferObjectManager, pOnClickListener);
    }
    ...
    public ButtonSprite(float pX, float pY, ITextureRegion pNormalTextureRegion, ITextureRegion pPressedTextureRegion, ITextureRegion pDisabledTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, OnClickListener pOnClickListener) {
        TiledTextureRegion tiledTextureRegion = new TiledTextureRegion(pNormalTextureRegion.getTexture(), pNormalTextureRegion, pPressedTextureRegion, pDisabledTextureRegion);
        this(pX, pY, (ITiledTextureRegion) tiledTextureRegion, pVertexBufferObjectManager, pOnClickListener);
    }
    ...
    public ButtonSprite(float pX, float pY, ITiledTextureRegion pTiledTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, OnClickListener pOnClickListener) {
        ...
        switch (this.mStateCount) {
            case 1:
                Debug.m1284w("No " + ITextureRegion.class.getSimpleName() + " supplied for " + State.class.getSimpleName() + "." + State.PRESSED + ".");
                break;
            case 2:
                break;
            case 3:
        ...
        Debug.m1284w("No " + ITextureRegion.class.getSimpleName() + " supplied for " + State.class.getSimpleName() + "." + State.DISABLED + ".");
    ...
    private void changeState(State pState) {
        if (pState != this.mState) {
            ...
            if (stateTiledTextureRegionIndex >= this.mStateCount) {
                ...
                Debug.m1284w(getClass().getSimpleName() + " changed its " + State.class.getSimpleName() + " to " + pState.toString() + ", which doesn't have a " + ITextureRegion.class.getSimpleName() + " supplied. Applying default " + ITextureRegion.class.getSimpleName() + ".");
                return;
            }
