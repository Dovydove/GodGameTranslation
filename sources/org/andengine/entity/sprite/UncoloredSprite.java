...
public class UncoloredSprite extends Sprite {
    ...
    public UncoloredSprite(float pX, float pY, float pWidth, float pHeight, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
        HighPerformanceUncoloredSpriteVertexBufferObject highPerformanceUncoloredSpriteVertexBufferObject = new HighPerformanceUncoloredSpriteVertexBufferObject(pVertexBufferObjectManager, 16, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pWidth, pHeight, pTextureRegion, (IUncoloredSpriteVertexBufferObject) highPerformanceUncoloredSpriteVertexBufferObject);
    }
    ...
    public UncoloredSprite(float pX, float pY, float pWidth, float pHeight, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType, ShaderProgram pShaderProgram) {
        HighPerformanceUncoloredSpriteVertexBufferObject highPerformanceUncoloredSpriteVertexBufferObject = new HighPerformanceUncoloredSpriteVertexBufferObject(pVertexBufferObjectManager, 16, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pWidth, pHeight, pTextureRegion, (IUncoloredSpriteVertexBufferObject) highPerformanceUncoloredSpriteVertexBufferObject, pShaderProgram);
    }
    ...
    public UncoloredSprite(float pX, float pY, float pWidth, float pHeight, ITextureRegion pTextureRegion, IUncoloredSpriteVertexBufferObject pUncoloredSpriteVertexBufferObject) {
        this(pX, pY, pWidth, pHeight, pTextureRegion, pUncoloredSpriteVertexBufferObject, (ShaderProgram) PositionTextureCoordinatesShaderProgram.getInstance());
    }
