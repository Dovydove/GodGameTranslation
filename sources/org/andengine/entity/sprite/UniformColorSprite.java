...
public class UniformColorSprite extends Sprite {
    ...
    public UniformColorSprite(float pX, float pY, float pWidth, float pHeight, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType, ShaderProgram pShaderProgram) {
        HighPerformanceUniformColorSpriteVertexBufferObject highPerformanceUniformColorSpriteVertexBufferObject = new HighPerformanceUniformColorSpriteVertexBufferObject(pVertexBufferObjectManager, 16, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pWidth, pHeight, pTextureRegion, (IUniformColorSpriteVertexBufferObject) highPerformanceUniformColorSpriteVertexBufferObject, pShaderProgram);
    }
    ...
    public UniformColorSprite(float pX, float pY, float pWidth, float pHeight, ITextureRegion pTextureRegion, IUniformColorSpriteVertexBufferObject pUniformColorSpriteVertexBufferObject) {
        this(pX, pY, pWidth, pHeight, pTextureRegion, pUniformColorSpriteVertexBufferObject, (ShaderProgram) PositionTextureCoordinatesUniformColorShaderProgram.getInstance());
    }
