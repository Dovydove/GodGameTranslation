...
public class SpriteBatch extends Shape {
    ...
    public SpriteBatch(ITexture pTexture, int pCapacity, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
        this(pTexture, pCapacity, (ISpriteBatchVertexBufferObject) new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * 30, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
    }
    ...
    public SpriteBatch(float pX, float pY, ITexture pTexture, int pCapacity, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
        HighPerformanceSpriteBatchVertexBufferObject highPerformanceSpriteBatchVertexBufferObject = new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * 30, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pTexture, pCapacity, (ISpriteBatchVertexBufferObject) highPerformanceSpriteBatchVertexBufferObject);
    }
    ...
    public SpriteBatch(ITexture pTexture, int pCapacity, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType, ShaderProgram pShaderProgram) {
        this(pTexture, pCapacity, (ISpriteBatchVertexBufferObject) new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * 30, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
    }
    ...
    public SpriteBatch(float pX, float pY, ITexture pTexture, int pCapacity, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType, ShaderProgram pShaderProgram) {
        HighPerformanceSpriteBatchVertexBufferObject highPerformanceSpriteBatchVertexBufferObject = new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * 30, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pTexture, pCapacity, (ISpriteBatchVertexBufferObject) highPerformanceSpriteBatchVertexBufferObject, pShaderProgram);
    }

    public SpriteBatch(ITexture pTexture, int pCapacity, ISpriteBatchVertexBufferObject pSpriteBatchVertexBufferObject) {
        this(pTexture, pCapacity, pSpriteBatchVertexBufferObject, (ShaderProgram) PositionColorTextureCoordinatesShaderProgram.getInstance());
    }
    ...
    public SpriteBatch(float pX, float pY, ITexture pTexture, int pCapacity, ISpriteBatchVertexBufferObject pSpriteBatchVertexBufferObject) {
        this(pX, pY, pTexture, pCapacity, pSpriteBatchVertexBufferObject, (ShaderProgram) PositionColorTextureCoordinatesShaderProgram.getInstance());
    }
    ...
    /* access modifiers changed from: protected */
    public void assertTexture(ITextureRegion pTextureRegion) {
    ...
    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pRotation, float pRed, float pGreen, float pBlue, float pAlpha) {
    ...
    /* access modifiers changed from: protected */
    public void addWithPackedColor(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pRotation, float pColorABGRPackedInt) {
        float widthHalf = pWidth * 0.5f;
        float heightHalf = pHeight * 0.5f;
        TRANSFORATION_TMP.setToIdentity();
        TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
    ...
    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pScaleX, float pScaleY, float pRed, float pGreen, float pBlue, float pAlpha) {
        float widthHalf = pWidth * 0.5f;
        float heightHalf = pHeight * 0.5f;
        TRANSFORATION_TMP.setToIdentity();
        TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
    ...
    /* access modifiers changed from: protected */
    public void addWithPackedColor(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pScaleX, float pScaleY, float pColorABGRPackedInt) {
        float widthHalf = pWidth * 0.5f;
        float heightHalf = pHeight * 0.5f;
        TRANSFORATION_TMP.setToIdentity();
        TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
    ...
    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pRotation, float pScaleX, float pScaleY, float pRed, float pGreen, float pBlue, float pAlpha) {
        float widthHalf = pWidth * 0.5f;
        float heightHalf = pHeight * 0.5f;
        TRANSFORATION_TMP.setToIdentity();
        TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
    ...
    /* access modifiers changed from: protected */
    public void addWithPackedColor(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pRotation, float pScaleX, float pScaleY, float pColorABGRPackedInt) {
        float widthHalf = pWidth * 0.5f;
        float heightHalf = pHeight * 0.5f;
        TRANSFORATION_TMP.setToIdentity();
        TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
    ...
    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pWidth, float pHeight, Transformation pTransformation, float pRed, float pGreen, float pBlue, float pAlpha) {
        VERTICES_TMP[0] = 0.0f;
        VERTICES_TMP[1] = 0.0f;
        VERTICES_TMP[2] = 0.0f;
    ...
    /* access modifiers changed from: protected */
    public void addWithPackedColor(ITextureRegion pTextureRegion, float pWidth, float pHeight, Transformation pTransformation, float pColorABGRPackedInt) {
        VERTICES_TMP[0] = 0.0f;
        VERTICES_TMP[1] = 0.0f;
        VERTICES_TMP[2] = 0.0f;
        VERTICES_TMP[3] = pHeight;
    ...
    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pRed, float pGreen, float pBlue, float pAlpha) {
        addInner(pTextureRegion, pX, pY, pX + pWidth, pY + pHeight, pRed, pGreen, pBlue, pAlpha);
    }

    /* access modifiers changed from: protected */
    public void add(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pColorABGRPackedInt) {
        this.mSpriteBatchVertexBufferObject.addWithPackedColor(pTextureRegion, pX, pY, pX + pWidth, pY + pHeight, pColorABGRPackedInt);
    }

    /* access modifiers changed from: protected */
    public void addWithPackedColor(ITextureRegion pTextureRegion, float pX, float pY, float pWidth, float pHeight, float pColorABGRPackedInt) {
        this.mSpriteBatchVertexBufferObject.addWithPackedColor(pTextureRegion, pX, pY, pX + pWidth, pY + pHeight, pColorABGRPackedInt);
    }
