...
public class Line extends Shape {
    ...
    public Line(float pX1, float pY1, float pX2, float pY2, float pLineWidth, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
        HighPerformanceLineVertexBufferObject highPerformanceLineVertexBufferObject = new HighPerformanceLineVertexBufferObject(pVertexBufferObjectManager, 6, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX1, pY1, pX2, pY2, pLineWidth, (ILineVertexBufferObject) highPerformanceLineVertexBufferObject);
    }
    ...
    public Line(float pX1, float pY1, float pX2, float pY2, float pLineWidth, ILineVertexBufferObject pLineVertexBufferObject) {
        ...
        onUpdateVertices();
        onUpdateColor();
        float centerY = (this.mY2 - this.f1205mY) * 0.5f;
        this.mRotationCenterX = (this.mX2 - this.f1204mX) * 0.5f;
    ...
    public boolean collidesWith(IShape pOtherShape) {
        if (pOtherShape instanceof Line) {
            ...
            return LineCollisionChecker.checkLineCollision(this.f1204mX, this.f1205mY, this.mX2, this.mY2, otherLine.f1204mX, otherLine.f1205mY, otherLine.mX2, otherLine.mY2);
