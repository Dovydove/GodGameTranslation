...
public class Mesh extends Shape {
    ...
    public Mesh(float pX, float pY, float[] pBufferData, int pVertexCount, DrawMode pDrawMode, VertexBufferObjectManager pVertexBufferObjectManager, DrawType pDrawType) {
        HighPerformanceMeshVertexBufferObject highPerformanceMeshVertexBufferObject = new HighPerformanceMeshVertexBufferObject(pVertexBufferObjectManager, pBufferData, pVertexCount, pDrawType, true, VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT);
        this(pX, pY, pVertexCount, pDrawMode, highPerformanceMeshVertexBufferObject);
    }
