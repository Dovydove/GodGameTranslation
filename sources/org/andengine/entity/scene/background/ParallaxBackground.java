...
public class ParallaxBackground extends Background {
    ...
    public static class ParallaxEntity {
        ...
        public void myDraw(GLState pGLState, Camera pCamera, float pParallaxValue) {
            ...
            do {
                this.mAreaShape.myDraw(pGLState, pCamera);
    ...
    public void myDraw(GLState pGLState, Camera pCamera) {
        ...
        for (int i = 0; i < this.mParallaxEntityCount; i++) {
            ((ParallaxEntity) parallaxEntities.get(i)).myDraw(pGLState, pCamera, parallaxValue);
        }
    }
