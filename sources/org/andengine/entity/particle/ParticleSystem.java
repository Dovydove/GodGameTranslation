...
public class ParticleSystem<T extends IEntity> extends Entity {
    ...
    public void onManagedDraw(GLState pGLState, Camera pCamera) {
        for (int i = this.mParticlesAlive - 1; i >= 0; i--) {
            this.mParticles[i].myDraw(pGLState, pCamera);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public void moveParticleToEnd(int pIndex) {
    ...
    private void spawnParticle() {
        if (this.mParticlesAlive < this.mParticlesMaximum) {
            ...
            for (int i2 = this.mParticleModifiers.size() - 1; i2 >= 0; i2--) {
                ((IParticleModifier) this.mParticleModifiers.get(i2)).onInitializeParticle(particle);
            }
            this.mParticlesAlive++;
        }
    }
    ...
    /* access modifiers changed from: protected */
    public float determineCurrentRate() {
