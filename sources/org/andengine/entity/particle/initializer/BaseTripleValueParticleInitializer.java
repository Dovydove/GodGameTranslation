...
public abstract class BaseTripleValueParticleInitializer<T extends IEntity> extends BaseDoubleValueParticleInitializer<T> {
    ...
    public abstract void onInitializeParticle(Particle<T> particle, float f, float f2, float f3);
    ...
    /* access modifiers changed from: protected */
    public final void onInitializeParticle(Particle<T> pParticle, float pValueA, float pValueB) {
