...
public abstract class BaseTripleValueSpanParticleModifier<T extends IEntity> extends BaseDoubleValueSpanParticleModifier<T> {
    ...
    public abstract void onSetInitialValues(Particle<T> particle, float f, float f2, float f3);

    /* access modifiers changed from: protected */
    public abstract void onSetValues(Particle<T> particle, float f, float f2, float f3, float f4);
    ...
    /* access modifiers changed from: protected */
    public void onSetValues(Particle<T> pParticle, float pPercentageDone, float pValueA, float pValueB) {
