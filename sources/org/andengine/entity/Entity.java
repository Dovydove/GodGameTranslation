...
public class Entity implements IEntity {
    ...
    /* renamed from: mX */
    protected float f1204mX;

    /* renamed from: mY */
    protected float f1205mY;
    ...
    public void sortChildren(boolean pImmediate) {
        if (this.mChildren != null) {
            if (pImmediate) {
                ZIndexSorter.getInstance().sort((List<IEntity>) this.mChildren);
            } else {
    ...
    public void sortChildren(IEntityComparator pEntityComparator) {
        if (this.mChildren != null) {
            ZIndexSorter.getInstance().sort((List) this.mChildren, (Comparator) pEntityComparator);
        }
    }
    ...
    public IEntity detachChild(IEntityMatcher pEntityMatcher) {
        ...
        return (IEntity) this.mChildren.remove((IMatcher<T>) pEntityMatcher, PARAMETERCALLABLE_DETACHCHILD);
    }
    ...
    public void registerEntityModifier(IEntityModifier pEntityModifier) {
        ...
        this.mEntityModifiers.add((IModifier<T>) pEntityModifier);
    }
    ...
    public Transformation getLocalToParentTransformation() {
        ...
        if (this.mLocalToParentTransformationDirty) {
            ...
            localToParentTransformation.postTranslate(this.f1204mX, this.f1205mY);
    ...
    public Transformation getParentToLocalTransformation() {
        ...
        if (this.mParentToLocalTransformationDirty) {
            ...
            parentToLocalTransformation.postTranslate(-this.f1204mX, -this.f1205mY);
            float rotation = this.mRotation;
            if (rotation != 0.0f) {
                float rotationCenterX = this.mRotationCenterX;
                float rotationCenterY = this.mRotationCenterY;
    ...
    public final void myDraw(GLState pGLState, Camera pCamera) {
        if (!this.mVisible) {
            return;
        }
    ...
    /* access modifiers changed from: protected */
    public void onApplyTransformations(GLState pGLState) {
    ...
    /* access modifiers changed from: protected */
    public void applyTranslation(GLState pGLState) {
        pGLState.translateModelViewGLMatrixf(this.f1204mX, this.f1205mY, 0.0f);
    }

    /* access modifiers changed from: protected */
    public void applyRotation(GLState pGLState) {
        float rotation = this.mRotation;
        if (rotation != 0.0f) {
            float rotationCenterX = this.mRotationCenterX;
            float rotationCenterY = this.mRotationCenterY;
    ...
    /* access modifiers changed from: protected */
    public void applySkew(GLState pGLState) {
        float skewX = this.mSkewX;
        float skewY = this.mSkewY;
        if (skewX != 0.0f || skewY != 0.0f) {
            float skewCenterX = this.mSkewCenterX;
    ...
    /* access modifiers changed from: protected */
    public void applyScale(GLState pGLState) {
        float scaleX = this.mScaleX;
        float scaleY = this.mScaleY;
        if (scaleX != 1.0f || scaleY != 1.0f) {
            float scaleCenterX = this.mScaleCenterX;
    ...
    public void onManagedDraw(GLState pGLState, Camera pCamera) {
        ...
        if (children == null || !this.mChildrenVisible) {
            ...
            postDraw(pGLState, pCamera);
            while (i < childCount) {
                ((IEntity) children.get(i)).myDraw(pGLState, pCamera);
                i++;
            }
        }
