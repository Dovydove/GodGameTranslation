...
public class Engine implements SensorEventListener, OnTouchListener, ITouchEventCallback, LocationListener {
    ...
    /* access modifiers changed from: protected */
    public boolean onTouchHUD(Camera pCamera, TouchEvent pSceneTouchEvent) {
        if (pCamera.hasHUD()) {
    ...
    /* access modifiers changed from: protected */
    public boolean onTouchScene(Scene pScene, TouchEvent pSceneTouchEvent) {
        if (pScene != null) {
    ...
    public void onDestroy() {
        ...
        try {
            ...
            try {
                ...
                Debug.m1274e("Could not join UpdateThread.", (Throwable) e);
                Debug.m1284w("Trying to manually interrupt UpdateThread.");
    ...
    /* access modifiers changed from: protected */
    public void convertSceneToSurfaceTouchEvent(Camera pCamera, TouchEvent pSurfaceTouchEvent) {
    ...
    /* access modifiers changed from: protected */
    public void onUpdateDrawHandlers(GLState pGLState, Camera pCamera) {
        this.mDrawHandlers.myDraw(pGLState, pCamera);
    }
    ...
    /* access modifiers changed from: protected */
    public void onDrawScene(GLState pGLState, Camera pCamera) {
        if (this.mScene != null) {
            this.mScene.myDraw(pGLState, pCamera);
        }
