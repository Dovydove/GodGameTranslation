...
public class Camera implements IUpdateHandler {
    ...
    public void onDrawHUD(GLState pGLState) {
        if (this.mHUD != null) {
            this.mHUD.myDraw(pGLState, this);
        }
    }
    ...
    public void applySceneToCameraSceneOffset(TouchEvent pSceneTouchEvent) {
        pSceneTouchEvent.offset(-this.mXMin, -this.mYMin);
    }

    /* access modifiers changed from: protected */
    public void applySceneToCameraSceneOffset(float[] pSceneCoordinates) {
        pSceneCoordinates[0] = pSceneCoordinates[0] - this.mXMin;
        pSceneCoordinates[1] = pSceneCoordinates[1] - this.mYMin;
    }

    /* access modifiers changed from: protected */
    public void unapplySceneToCameraSceneOffset(TouchEvent pCameraSceneTouchEvent) {
        pCameraSceneTouchEvent.offset(this.mXMin, this.mYMin);
    }

    /* access modifiers changed from: protected */
    public void unapplySceneToCameraSceneOffset(float[] pCameraSceneCoordinates) {
    ...
    /* access modifiers changed from: protected */
    public void onSurfaceSizeInitialized(int pSurfaceX, int pSurfaceY, int pSurfaceWidth, int pSurfaceHeight) {
    ...
    /* access modifiers changed from: protected */
    public void onSurfaceSizeChanged(int pOldSurfaceX, int pOldSurfaceY, int pOldSurfaceWidth, int pOldSurfaceHeight, int pNewSurfaceX, int pNewSurfaceY, int pNewSurfaceWidth, int pNewSurfaceHeight) {
