        ...
        if (numMatchConstraints <= 0 || numMatchConstraints != numVisibleWidgets) {
            ...
            if (isChainPacked) {
                ...
                while (widget2 != null) {
                    ...
                    ConstraintWidget next2 = widget2.mListNextVisibleWidget[orientation];
                ...
                while (widget3 != null) {
                    ...
                    ConstraintWidget next3 = widget3.mListNextVisibleWidget[orientation];
                    if (next3 != null || widget3 == lastVisibleWidget) {
                        if (orientation == 0) {
            ...
            if (isChainSpread) {
                ...
                ConstraintWidget next4 = widget4.mListNextVisibleWidget[orientation];
                if (next4 != null) {
                    position += (float) next4.mListAnchors[offset].getMargin();
                }
            }
            while (widget4 != null) {
                if (LinearSystem.sMetrics != null) {
