...
public interface IDynamiteLoader extends IInterface {
    ...
    public static abstract class Stub extends zzb implements IDynamiteLoader {
        ...
        public boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    int moduleVersion = getModuleVersion(com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
                ...
                case 2:
                    ...
                    break;
                case 3:
                    int moduleVersion2 = getModuleVersion2(com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), zzc.zza(parcel));
                    parcel2.writeNoException();
