...
public interface IDynamiteLoaderV2 extends IInterface {
    ...
    public static abstract class Stub extends zzb implements IDynamiteLoaderV2 {
        ...
        public boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    IObjectWrapper loadModule = loadModule(com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.createByteArray());
                    parcel2.writeNoException();
                    zzc.zza(parcel2, (IInterface) loadModule);
                    break;
                case 2:
                    IObjectWrapper loadModule2 = loadModule2(com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()), parcel.readString(), parcel.readInt(), com.google.android.gms.dynamic.IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()));
                    parcel2.writeNoException();
