...
public class GoogleCertificatesQuery extends AbstractSafeParcelable {
    ...
    @Field(getter = "getCallingPackage", mo6912id = 1)
    private final String zzbh;
    @Field(getter = "getCallingCertificateBinder", mo6912id = 2, type = "android.os.IBinder")
    @Nullable
    private final CertData zzbi;
    @Field(getter = "getAllowTestKeys", mo6912id = 3)
    private final boolean zzbj;

    @Constructor
    GoogleCertificatesQuery(@Param(mo6915id = 1) String str, @Param(mo6915id = 2) @Nullable IBinder iBinder, @Param(mo6915id = 3) boolean z) {
        this.zzbh = str;
