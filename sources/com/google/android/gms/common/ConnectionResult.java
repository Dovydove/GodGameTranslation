...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo6912id = 2)
    private final int zzam;
    @Field(getter = "getResolution", mo6912id = 3)
    private final PendingIntent zzan;
    @Field(getter = "getErrorMessage", mo6912id = 4)
    ...
    @Constructor
    ConnectionResult(@Param(mo6915id = 1) int i, @Param(mo6915id = 2) int i2, @Param(mo6915id = 3) PendingIntent pendingIntent, @Param(mo6915id = 4) String str) {
        this.zzal = i;
        this.zzam = i2;
