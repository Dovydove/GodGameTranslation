...
public final class ConnectionEvent extends StatsEvent {
    ...
    @Field(getter = "getEventType", mo6912id = 12)
    private int zzxw;
    @Field(getter = "getCallingProcess", mo6912id = 4)
    private final String zzxx;
    @Field(getter = "getCallingService", mo6912id = 5)
    private final String zzxy;
    @Field(getter = "getTargetProcess", mo6912id = 6)
    private final String zzxz;
    @Field(getter = "getTargetService", mo6912id = 7)
    private final String zzya;
    @Field(getter = "getStackTrace", mo6912id = 8)
    private final String zzyb;
    @Field(getter = "getEventKey", mo6912id = 13)
    private final String zzyc;
    @Field(getter = "getElapsedRealtime", mo6912id = 10)
    private final long zzyd;
    @Field(getter = "getHeapAlloc", mo6912id = 11)
    private final long zzye;
    private long zzyf;

    @Constructor
    ConnectionEvent(@Param(mo6915id = 1) int i, @Param(mo6915id = 2) long j, @Param(mo6915id = 12) int i2, @Param(mo6915id = 4) String str, @Param(mo6915id = 5) String str2, @Param(mo6915id = 6) String str3, @Param(mo6915id = 7) String str4, @Param(mo6915id = 8) String str5, @Param(mo6915id = 13) String str6, @Param(mo6915id = 10) long j2, @Param(mo6915id = 11) long j3) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzxx = str;
