...
public final class WakeLockEvent extends StatsEvent {
    ...
    @Field(getter = "getTimeout", mo6912id = 16)
    private final long mTimeout;
    @VersionField(mo6918id = 1)
    private final int zzal;
    @Field(getter = "getTimeMillis", mo6912id = 2)
    private final long zzxv;
    @Field(getter = "getEventType", mo6912id = 11)
    private int zzxw;
    @Field(getter = "getElapsedRealtime", mo6912id = 8)
    private final long zzyd;
    private long zzyf;
    @Field(getter = "getWakeLockName", mo6912id = 4)
    private final String zzyq;
    @Field(getter = "getSecondaryWakeLockName", mo6912id = 10)
    private final String zzyr;
    @Field(getter = "getCodePackage", mo6912id = 17)
    private final String zzys;
    @Field(getter = "getWakeLockType", mo6912id = 5)
    private final int zzyt;
    @Field(getter = "getCallingPackages", mo6912id = 6)
    private final List<String> zzyu;
    @Field(getter = "getEventKey", mo6912id = 12)
    private final String zzyv;
    @Field(getter = "getDeviceState", mo6912id = 14)
    private int zzyw;
    @Field(getter = "getHostPackage", mo6912id = 13)
    private final String zzyx;
    @Field(getter = "getBeginPowerPercentage", mo6912id = 15)
    private final float zzyy;

    @Constructor
    WakeLockEvent(@Param(mo6915id = 1) int i, @Param(mo6915id = 2) long j, @Param(mo6915id = 11) int i2, @Param(mo6915id = 4) String str, @Param(mo6915id = 5) int i3, @Param(mo6915id = 6) List<String> list, @Param(mo6915id = 12) String str2, @Param(mo6915id = 8) long j2, @Param(mo6915id = 14) int i4, @Param(mo6915id = 10) String str3, @Param(mo6915id = 13) String str4, @Param(mo6915id = 15) float f, @Param(mo6915id = 16) long j3, @Param(mo6915id = 17) String str5) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzyq = str;
