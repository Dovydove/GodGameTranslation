...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo6915id = 1) int i, @Param(mo6915id = 2) int i2, @Param(mo6915id = 3) int i3, @Param(mo6915id = 4) String str, @Param(mo6915id = 5) IBinder iBinder, @Param(mo6915id = 6) Scope[] scopeArr, @Param(mo6915id = 7) Bundle bundle, @Param(mo6915id = 8) Account account, @Param(mo6915id = 10) Feature[] featureArr, @Param(mo6915id = 11) Feature[] featureArr2, @Param(mo6915id = 12) boolean z) {
        this.version = i;
        this.zzst = i2;
        this.zzsu = i3;
