...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @VersionField(mo6918id = 1000)
    private final int zzal;
    @Field(getter = "getStatusCode", mo6912id = 1)
    private final int zzam;
    @Nullable
    @Field(getter = "getPendingIntent", mo6912id = 3)
    private final PendingIntent zzan;
    @Nullable
    @Field(getter = "getStatusMessage", mo6912id = 2)
    ...
    @Constructor
    @KeepForSdk
    Status(@Param(mo6915id = 1000) int i, @Param(mo6915id = 1) int i2, @Nullable @Param(mo6915id = 2) String str, @Nullable @Param(mo6915id = 3) PendingIntent pendingIntent) {
        this.zzal = i;
        this.zzam = i2;
        this.zzao = str;
